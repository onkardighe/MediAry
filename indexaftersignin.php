...
<body>
    ...
    <section class="background firstsection" id="background">
        <div class="box-main">
            <div class="firsthalf">
                <div class="counter">
            ...
            <div class="statitiscs">
                <h2 id="statistics">Covid Statistics of India</h2>
...
donate page add karaych
requirement page add karaych

sign up cha data join karaych
donate reqire data show karayla page create karaych

$(document).ready(function () {
  ...
  function bedsinfo()
  {
    var url = "https://api.covidbedsindia.in/v1/storages/608efad8423e2153ac2fd383/Nashik";
    var data = "";
    ...
    $.get(url, function (data) {
            ...
            for(var x in data)
            {
                ...
                hospitalsel.options[hospitalsel.options.length] = new Option(HosptalName, x);
            }

            hospitalsel.onchange = function(){
                console.log(data[this.value]);
                document.getElementById("hospdoctname").innerHTML =data[this.value].DOCTOR_NAME;
                document.getElementById("popuphospital").style.display = "block";
                document.getElementById("hospitalName").innerHTML =data[this.value].HOSPITAL_NAME;
                document.getElementById("hospaddress").innerHTML =data[this.value].HOSPITAL_ADDRESS;
                document.getElementById("hospcontact").innerHTML =data[this.value].HOSPITAL_NUMBER;
                document.getElementById("hospavailgenbeds").innerHTML =data[this.value].BEDS_WITHOUT_OXYGEN_AVAILABLE;
                document.getElementById("hospavailoxybeds").innerHTML =data[this.value].BEDS_WITH_OXYGEN_AVAILABLE;
                document.getElementById("hospavailicubeds").innerHTML =data[this.value].ICU_BEDS_AVAILABLE;
                document.getElementById("hospavailventbeds").innerHTML =data[this.value].VENTILATOR_AVAILABLE;
            };
...
// function checkWhichBtn()
// {
// 	var vaccformbedform = document.getElementById("bedform")
// 	var vaccform = document.getElementById("vaccform");
// 	if(vaccform.style.display === "none")
// 	{
// 		console.log("vaccform nonde");
// 		bedform.style.width = "20%";
// 		bedform.style.color = "black";
// 		bedform.style.background = "white";
// 	}  
// 	else if(bedform.style.display === "none")
// 	{
// 		vaccform.style.width = "20%";
// 		vaccform.style.color = "black";
// 		vaccform.style.background = "white";
// 	}  
// }
